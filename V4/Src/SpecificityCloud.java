...
class Term extends JLabel implements MouseListener {
    ...
    public void mouseEntered(MouseEvent event) {
        this.setToolTipText(this.cloud.displayAssociations());
        ...
        if ((this.filteredRewritingVector != null) && (!this.currentFilter.equals(""))) {
            ...
            for (Integer i : initialRewritingVector.getVector().keySet()) {
              ...
              //  assoc.put(String.valueOf(this.filters), associationDegree);
                ...
                System.out.println("Association degree between filter and this label is:" + result);
        ...
        if ((this.filteredRewritingVector != null) && (!this.currentFilter.equals(""))) {
         ...
         //   RewritingVector rw = new RewritingVector();
            ...
            for (Integer i : initialRewritingVector.getVector().keySet()) {
                ...
                for (Integer j : initialRewritingVector.getVector().keySet()) {
                    ...
                    sum += filteredRewritingVector.getVector().get(j) - initialRewritingVector.getVector().get(i) / qi;
                    X += 1;
                    divScore = 1 - sqrt(sum / abs(X));
                    String result = ret.concat(div.toString());
                    //System.out.println("result" +result);
                    div.put(i, divScore);
                    System.out.println("The diversity score degree between filter and this label is:" + result);
                }
            }
        }
